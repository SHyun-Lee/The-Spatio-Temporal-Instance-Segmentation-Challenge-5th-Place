...
def main():
    ...
    parser.add_argument('--config', type=str, default='configs/predict/sis_challenge_gray.yaml')
    ...
    gray_detector = Sam2YoloDetector(**config['gray_detector'], device=args.device)
    e2vid_detector = Sam2YoloDetector(**config['e2vid_detector'], device=args.device)
